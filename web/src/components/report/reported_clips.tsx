   ...
   return (
      <React.Fragment>
         <TableRow className={classes.root}>
            ...
            <TableCell align="left">{item.clip.id}</TableCell>
...
export default function ReportedClipsList() {
   const [items, setItems] = React.useState<Report[]>();

   React.useEffect(() => {
      async function apiCall() {
         const apiResponse = await fetch('/api/v1/report/reported_clips')
   ...
   return (
      <>
         <h1>Reported Clips</h1>
         <p>Reported with errors</p>
            ...
            <Table aria-label="collapsible table">
               <TableHead>
                  <TableRow>
                     ...
                     <TableCell align="left">Clip</TableCell>
